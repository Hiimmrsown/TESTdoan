...
text1.onchange = function(){
    ...
    database.ref("/IOT").update({
        ...
        {
        alert('Vui lòng nhập lại bằng một con số');
        }
    }
text2.onchange = function(){
    var temp = text2.value;
    if(!isNaN(temp)){
    temp = parseFloat(temp);
    database.ref("/IOT").update({
        HUMI_L: temp
...
database.ref("/IOT/TEMP").on("value", function(snapshot){
 ...
 localStorage.wesite = data1[0].data.push([Date.UTC(today.getFullYear(), today.getMonth(), today.getDate(), today.getHours(), today.getMinutes()), TEMP]);
...
//------------------------------------------------------------------------- độ ẩm------------------------------------------
 ...
 data1[1].data.push([Date.UTC(today.getFullYear(), today.getMonth(), today.getDate(), today.getHours(), today.getMinutes()), HUMI]);
 localStorage.wesite = data1[1].data.push([Date.UTC(today.getFullYear(), today.getMonth(), today.getDate(), today.getHours(), today.getMinutes()), HUMI]);
 console.log(data1[1].data[data1[1].data.length-1]);
 console.log(HUMI);
 abc();
